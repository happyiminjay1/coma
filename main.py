...
HOI_info_train = HOI_info('/scratch/minjay/coma/data/CoMA/processed/interpolation/training_total.pkl')
HOI_info_test = HOI_info('/scratch/minjay/coma/data/CoMA/processed/interpolation/test_total.pkl')
...
checkpoint = torch.load('/scratch/minjay/coma/out/interpolation_exp_mano_contact[32, 32, 32, 64] 64/checkpoints/checkpoint_300.pt')
...
train_eval.run(model,train_loader, train_loader_hoi, test_loader, test_loader_hoi, args.epochs, optimizer,
               scheduler, writer, meshdata,  args.exp_name, device)
